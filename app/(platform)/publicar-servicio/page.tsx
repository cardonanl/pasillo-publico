...
export const metadata: Metadata = {
  title: "Publicar servicio — Pasillo Público",
};
    ...
    return (
      <main className="mx-auto max-w-xl px-6 py-16 text-center">
        ...
        <p className="mt-3 text-sm text-pp-ink2">
          Activa la opción <em>&ldquo;Soy artista o creador/a&rdquo;</em> en tu
          perfil. Un administrador revisará y aprobará tu cuenta.
        </p>
        <Link
  ...
  return (
    <main className="mx-auto max-w-2xl px-6 py-10">
      ...
      <p className="mb-8 text-sm text-pp-ink2">
        Tu servicio quedará visible en tu{" "}
        <span className="italic text-pp-blue">pasillo</span> al publicarlo.
      </p>

      <ServiceForm profileId={profile.id} categories={categories ?? []} />
    </main>
  );
}
